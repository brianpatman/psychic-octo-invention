...
function TrashIcon(){
	return <>
		<svg className="fill-white h-5 w-5 mx-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
function EditIcon(){
	return <>
		<svg className="fill-white h-5 w-5 mx-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
